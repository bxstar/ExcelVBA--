...
'chartType - excel chart type(xlPiexlLine etc.)
'chartName - Chart name
'titleChart - chart title
'...

'Example
'Call MakeChart(Report, A1D8, Report, Cells(11, C).Left, Cells(11, C).Top, 240, 245, xlPie, TopChart1, Conversions Per Search Engine, msoElementDataLabelBestFit, Array(#,##0.00), False)
'
