Sub AddSheet(ByVal sheetName As String, Optional ByVal AfterS As String = "", Optional ByVal ColorTab As Long = xlAutomatic)
...
Sub DuplicateSheet(ByVal srcSheetName As String, ByVal sheetName As String, Optional ByVal AfterS As String = "", Optional ByVal ColorTab As Long = xlAutomatic)
...
Sub ColorTabSheet(ByVal sheetName As String, ByVal MyColor As Long)
    Worksheets(sheetName).Tab.color = MyColor
End Sub

Sub AddColorToLife(ByVal dataSheet As String, ByVal rang As String, ByVal ColorGet As Long, ByVal R As Long, ByVal G As Long, ByVal B As Long)
    If ColorGet <> 0 Then
...
End Sub
Sub AddTable(ByVal dataSheet As String, ByVal StartRowT As Long, ByVal LastRowT As Long, ByVal StartColumnT As String, ByVal EndColumnT As String, ByVal StartPivotT As Long)
    Dim rang As String
    Dim rang2 As String
    Dim rang3 As String
    Dim flag As Boolean
...
End Sub
Sub AddBorder(ByVal dataSheet As String, ByVal rang As String)
    Sheets(dataSheet).Activate()
    Range(rang).Select()
...
End Sub
Sub FormatColumnDollar(ByVal dataSheet As String)
...
End Sub
Sub CheckAll(ByVal PivotName As String, ByVal field As String)
...
End Sub
'add uniqe column
Sub AddColumnConcat(ByVal dataSheet As String)
    Dim LastRow As Long
    Dim LastCol As Long
...
End Sub
Sub FillZeros(ByVal dataSheet As String, ByVal StartColumn As Integer, ByVal EndColumn As Integer, ByVal StartRow As Integer, ByVal EndRow As Integer)
    Dim i As Integer
    Dim j As Integer
...
End Sub
Sub FillZerosAll(ByVal dataSheet As String, ByVal StartColumn As Integer, ByVal EndColumn As Integer, ByVal StartRow As Integer, ByVal EndRow As Integer)
    Dim i As Integer
    Dim j As Integer
    For i = StartColumn To EndColumn
        For j = StartRow To EndRow
...
End Sub
Sub AddColumnConcatS(ByVal dataSheet As String)
    Dim LastRow As Long
    Dim LastCol As Long
    Dim LastCell As String
    LastRow = Sheets(dataSheet).Range("A65536").End(xlUp).Row
...
End Sub
Sub FormatToolTip(ByVal valDDL As String, ByVal Range As String)
